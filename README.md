...
**Authors:** Grzegorz Mozdzynski, Hajar Sriri, Chopard Jules[cite: 195].

## Dataset
The data is sourced from the World Bank, IEA, and "Our World in Data". It includes:
...
1.  **Data Cleaning:** KNN Imputation ($k=3$) to handle missing values while preserving local tendencies[cite: 281].
2.  **Feature Selection:** Mixed stepwise selection to identify the most significant predictors (e.g., Renewable generating capacity, Energy intensity, GDP per capita)[cite: 315].
3.  **Modeling:** We compared four models:
    * Linear Regression (OLS)
    * Lasso Regression
    * Ridge Regression
    * Random Forest Regressor [cite: 325-328].
